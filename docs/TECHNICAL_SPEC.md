...
Современный desktop browser должен отображать тот же интерфейс корректно и быть пригоден для разработки/диагностики.
...
- не быть жёстко привязанным к одной физической resolution;
